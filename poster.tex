  ...
  \begin{minipage}{.9\textwidth}%
    ...
    \begin{minipage}[][][t]{.285\textwidth}
      \innerblock[titleleft]{Data flow in SIMEX}{%
        \begin{center}%
          \includegraphics[width=0.9\textwidth,angle=0,clip]{figures/simex_workflow_slide-crop}%
        \end{center}%
      }
    \end{minipage}%
    \hfill%
    \begin{minipage}[][][t]{.205\textwidth}
      \innerblock[titleleft]{Python scripting}{%
        \begin{center}%
          \includegraphics[width=0.9\textwidth,angle=0,clip]{figures/simex_script}%
        \end{center}%
      }
    \end{minipage}%
    \hfill%
    \begin{minipage}[][][t]{.1\textwidth}
      \innerblock[titleleft]{Standardized data format}{%
        \begin{center}%
          \includegraphics[width=0.42\textwidth,angle=0,clip]{figures/opmd_screenshot}\\
    ...
    {%
      ...
      \begin{minipage}[ ]{.9\colwidth}
          \begin{center}
            ...
            \includegraphics[width=.99\textwidth,angle=0,clip]{scattering_vs_pulseduration-crop}\\
              {\small Photon counts and scattering efficiency vs.
            pulse duration }
            \end{minipage}
            \begin{minipage}[][][t]{.43\textwidth}
              \includegraphics[width=.9\textwidth,angle=0,clip]{figures/diffr_orient_flow}
            \end{minipage}
            {\small%
            \begin{equation*}
