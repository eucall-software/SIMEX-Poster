...
\column{0.5}%
%%%
\block[bodyoffsetx=-10pt]{X-ray diffraction in underdense plasmas}{%
...
\block[bodyoffsetx=-10pt]{X-ray diagnostics of Warm Dense Iron [3]}{%
...
\begin{minipage}[][][t]{0.345\textwidth}
  ...
  \begin{enumerate}
    \item Burau et al. IEEE Trans. Plasma Sc. \textbf{38} (2010), www.picongpu.org
    \item Chung et al, HEDP \textbf{1} (2005).
    \item
    \item Yoon et al. submitted.
    \item Lecz et al. Phys. Plasma \textbf{22} (2015), Lecz et al. PRE \textbf{93} (2016).
