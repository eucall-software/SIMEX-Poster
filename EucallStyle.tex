...
\definetitlestyle{Eucall}{%
    ...
    \begin{scope}[line width=\titlelinewidth, rounded corners=\titleroundedcorners]%
      ...
      \pgftext[right, x=\titleposleft+0.18\textwidth, y=0.5\titlepostop+0.5\titleposbottom]{\includegraphics[width=0.18\textwidth]{eucall_logo.png}}%
...
\defineblockstyle{EucallLeft}{
    ...
    titleoffsetx=0pt, titleoffsety=0pt, bodyoffsetx=0pt, bodyoffsety=-10pt,
    bodyverticalshift=0pt, roundedcorners=30, linewidth=0.0cm,
    titleinnersep=1cm, bodyinnersep=1cm
}{%
    \begin{scope}[line width=\blocklinewidth, rounded corners=\blockroundedcorners]%
        \ifBlockHasTitle %
           \draw[left color=ECGreen, right color=ECYellowGreen] (blocktitle.south west) rectangle (blocktitle.north east);
...
\defineblockstyle{EucallRight}{
    ...
    \begin{scope}[line width=\blocklinewidth, rounded corners=\blockroundedcorners]
        \ifBlockHasTitle %
           \draw[left color=ECYellowGreen, right color=ECYellow] (blocktitle.south west) rectangle (blocktitle.north east);
